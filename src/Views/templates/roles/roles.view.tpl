    ...
    <table>
        <thead>
            <tr>
                ...
                <th>Estado</th>
                <th>
                    <a href="index.php?page=Roles_Role&mode=INS">Nuevo</a>
                </th>
            </tr>
        </thead>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="index.php?page=Roles_Role&mode=DSP&rolescod={{rolescod}}">
                        {{rolesdsc}}
                    </a>
                </td>
                ...
                <td class="center">
                    <a href="index.php?page=Roles_Role&mode=UPD&rolescod={{rolescod}}">Editar</a>
                    <a href="index.php?page=Roles_Role&mode=DEL&rolescod={{rolescod}}">Eliminar</a>
                </td>
            </tr>
            {{endfor roles}}
        </tbody>
